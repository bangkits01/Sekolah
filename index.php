...
<html lang="en">
  ...
  <body>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit-siswa.php?id=<?php echo $row['id_siswa'] ?>" class="btn btn-sm btn-primary" onclick = "return edit()">EDIT</a>
                        <a href="hapus-siswa.php?id=<?php echo $row['id_siswa'] ?>" class="btn btn-sm btn-danger" onclick = "return hapus()">HAPUS</a>
                      </td>
                  </tr>
    ...
    <script>
      ...
      function edit(){
        if(confirm('Apakah Kamu Yakin Ingin Mengedit Data??')){
        return true;
      }else{
